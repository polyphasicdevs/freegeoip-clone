...
`Note:` This plugin will not work on local machine because the Localhost IP 127.0.0.1 So it works on live site
...
= 3.2 =
This version fixes deactivate and additional post types bug. Upgrade immediately.
= 3.1 =
